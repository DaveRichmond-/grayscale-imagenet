...
tf.app.flags.DEFINE_string(
    'dataset_name', 'nihxray3', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
    'dataset_split_name', 'test', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_dir', '/media/whi-gpu01/fd2bf426-d2ee-4129-8a76-35c8216ac3a3/NIH-Xray/output_3chan/', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'preprocessing_name', 'nihxray3', 'The name of the preprocessing to use. If left '
